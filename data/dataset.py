...
train_transforms = A.Compose([
    ...
    A.ChannelShuffle(p=0.55),
    A.CoarseDropout(max_holes=50, max_height=2, max_width=2, p=0.2), 
    A.ImageCompression(p=0.2, quality_lower=55, quality_upper=90),
    A.ShiftScaleRotate(p=0.15, rotate_limit=10, mask_value=(255, 255, 255), shift_limit_x=0.1, shift_limit_y=0.1, 
